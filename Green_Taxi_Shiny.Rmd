...
I set up the input options for longtitude and latitude with sliders. Once that data is input, the program would make a prediction for which cluster it belongs to based on the input and kmeans model. Then, it would give 20 recommended pick up spots within the cluster.  
